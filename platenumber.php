                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="dashboard_header_title">
                                <h3>Car Number Plates</h3>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="dashboard_breadcam text-end">
                                <p><a href="index_3.php">Home</a> <i class="fas fa-caret-right"></i> Plate Number</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="modal-content cs_modal">
                                    <div class="modal-header theme_bg_1 justify-content-center">
                                        <h5 class="modal-title text_white">Register PlateNumber</h5>
                                    </div>
                                    <div class="modal-body">
<form action="platenumber.php" method="POST">
    <div class="">
        <input type="text" class="form-control" name="platenumb" placeholder="Plate Number" required>
    </div>

    <div class="">
        <input type="text" class="form-control" name="phonenumb" placeholder="Phone Number" required>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer_iner text-center">
                    <p>2025 © UgandaPolice by <a href="#"> <i class="ti-heart"></i> </a><a href="#">SwabrahUkasha</a></p>
                </div>
            </div>
        </div>
    </div>
