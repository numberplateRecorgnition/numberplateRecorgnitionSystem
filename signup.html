...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO login (username, userrole, password) VALUES (?, ?, ?)");
    $stmt->bind_param("sss", $username, $userrole, $password); // "sss" means all are strings
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="dashboard_breadcam text-end">
                                <p><a href="index_3.html">Home</a> <i class="fas fa-caret-right"></i> Signup</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="modal-content cs_modal">
                                    <div class="modal-header theme_bg_1 justify-content-center">
                                        <h5 class="modal-title text_white">Signup</h5>
                                    </div>
...
<form action="signup.php" method="POST">
    ...
    <div class="">
        <input type="text" class="form-control" name="userrole" placeholder="role" required>
