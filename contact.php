...
$dbname = "trafic"; // Replace with your database name
...
// Fetch offences from the database
$sql = "SELECT id, title , charge FROM penalty";
...
<tbody>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td class='w_70'></td>"; // Placeholder cell
                echo "<td>";
                echo "<div class='payment_gatway'>";
                echo "<h5 class='byer_name f_s_16 f_w_700 color_theme'>" . htmlspecialchars($row['title']) . "</h5>";
                echo "</div>";
                echo "</td>";
                echo "<td>";
                echo "<div class='payment_gatway text-end'>";
                echo "<h5 class='byer_name f_s_16 f_w_700 color_theme'>" . htmlspecialchars($row['charge']) . "</h5>";
                echo "</div>";
                echo "</td>";
                echo "<td class='text-end'>";
                echo "<a href='edit_offence.php?id=" . urlencode($row['id']) . "' class='btn btn-sm btn-primary'>Edit</a> ";
                echo "<a href='delete_offence.php?id=" . urlencode($row['id']) . "' class='btn btn-sm btn-danger' onclick='return confirm(\"Are you sure you want to delete this offence?\")'>Delete</a>";
                echo "</td>";
                echo "</tr>";
            }
        } else {
            echo "<tr><td colspan='3'>No offences found.</td></tr>";
        }
        ?>
    </tbody>
</table>
