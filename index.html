...
<!-- Mirrored from demo.dashboardpack.com/marketing-html/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 May 2025 16:46:33 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
...
<div>
 ...
 <nav class="sidebar dark_sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
  <div class="logo d-flex justify-content-between" >
        <a href="index_3.html"><img src="img/one.jpg"  alt="" width="200" height="100"></a>
  ...
  <div class="marquee-content">
    <div class="item">
      <img src="img/five.jpg" alt="Label 1">
      <p>Traffic Mgt</p>
    </div>
    <div class="item">
      <img src="img/two.jpg" alt="Label 2">
      <p>Drinking While Driving</p>
    </div>
    <div class="item">
      <img src="img/three.png" alt="Label 3">
      <p> Driving While On Phone</p>
    </div>
    <div class="item">
      <img src="img/four.jpg" alt="Label 3">
      <p> Reckless Drivers</p>
    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="dashboard_header_title">
                                <h6>NUMBER PLATE RECOGNITION SYSTEM FOR UGANDA POLICE TICKETING (ESP)</h3>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="dashboard_breadcam text-end">
                                <p><a href="index.php">The Admin Center</a> <i class="fas fa-caret-right"></i> login</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer_iner text-center">
                    <p>2025 © UgandaPolice by <a href="#"> <i class="ti-heart"></i> </a><a href="#"> Swabrah Ukasha</a></p>
                </div>
            </div>
        </div>
    </div>
...
<!-- Mirrored from demo.dashboardpack.com/marketing-html/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 May 2025 16:47:23 GMT -->
</html>