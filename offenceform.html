...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO penalty (title, charge) VALUES (?, ?)");
    $stmt->bind_param("ss", $title, $charge); // "ss" means both are strings
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="dashboard_breadcam text-end">
                                <p><a href="index_3.php">Home</a> <i class="fas fa-caret-right"></i> Offences</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="modal-content cs_modal">
                                    <div class="modal-header theme_bg_1 justify-content-center">
                                        <h5 class="modal-title text_white">Register Offence</h5>
                                    </div>
                                    <div class="modal-body">
<form action="offenceform.php" method="POST">
    <div>
        <input type="text" class="form-control" name="title" placeholder="Offence Name" required>
    </div>
    <div>
